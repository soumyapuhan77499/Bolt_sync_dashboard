...
@section('title', 'Manual Sync - Bolt Sync Admin')
@section('page_title', 'Manual Sync')
@section('page_subtitle', 'Create source-destination table mappings and run manual sync jobs')
...
<style>
    ...
    .stat-card, .panel-card, .form-card, .table-card {
        background: #fff;
...
<div class="stats-grid">
    ...
    <div class="stat-card">
        <div class="stat-label">Total Sync Runs</div>
...
<div class="form-card" style="margin-bottom:22px;">
    <h3>Create / Update Sync Mapping</h3>
    ...
    <form action="{{ route('admin.sync-jobs.save-mapping') }}" method="POST">
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="Example: Profiles Mirror Sync" required>
            </div>

            <div class="form-group">
                <label class="form-label">Sync Mode</label>
                <select name="sync_mode" class="form-select" required>
                    <option value="mirror">Mirror (delete destination rows and copy again)</option>
                    <option value="append">Append (insert source rows only)</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="selected_columns" class="form-control" placeholder="Example: id, email, full_name">
            </div>

            <div class="form-group full">
                <label class="form-label">Notes</label>
                <textarea name="notes" class="form-textarea" placeholder="Optional sync notes"></textarea>
            </div>
...
<div class="table-card" style="margin-bottom:22px;">
    ...
    @else
        <div class="empty-box">No sync mappings found.</div>
    @endif
</div>
...
<div class="table-card" style="margin-bottom:22px;">
    ...
    @else
        <div class="empty-box">No sync runs found.</div>
    @endif
</div>

<div class="table-card">
    <h3>Recent Sync Run Logs</h3>
    ...
    @else
        <div class="empty-box">No sync run logs found.</div>
    @endif
</div>
@endsection